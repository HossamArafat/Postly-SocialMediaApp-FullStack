...
const StoryCard = ({story, setShowStory}) => {
  ...
  return (
    <div onClick={()=> setShowStory(story)} className={`relative rounded-lg shadow min-w-30 bg-linear-to-b from-indigo-500 to-purple-600 cursor-pointer transition hover:shadow-lg hover:from-indigo-700 hover:to-purple-800 active:scale-90`}>
